...
ga('create', 'UA-5033010-1', 'mit.edu', {'name': 'hewlettOERTracker'});
...
ga('hewlettOERTracker.send', 'pageview', location.pathname + location.search + location.hash);
